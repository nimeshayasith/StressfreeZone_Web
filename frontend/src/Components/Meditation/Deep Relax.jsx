...
<main className="flex flex-col mb-5 mt-20 p-7 bg-black bg-opacity-20">
  <header className="flex relative mb-5 gap-10 items-start w-full font-bold text-white max-w-[1145px] pr-[807px] max-md:pr-5 max-md:max-w-full">
    <h1 className="z-0 text-2xl">Movements</h1>
  </header>


  <div className="min-h-screen w-full px-4 py-10 bg-gray-800 relative">
      <div className="grid grid-cols-3 gap-6 mt-4 max-md:grid-cols-1">
