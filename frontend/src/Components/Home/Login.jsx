...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      ...
      const response = await axios.post("http://stressfreezone-web-frontend.onrender.com/api/auth/login", {
        email,
        password
      });
  ...
  const handleForgotPassword = async () => {
    try {
      ...
      await axios.post("http://stressfreezone-web-frontend.onrender.com/api/auth/forgot-password", { email });
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      const res = await axios.post("http://stressfreezone-web-frontend.onrender.com/api/auth/login-google", { token });
